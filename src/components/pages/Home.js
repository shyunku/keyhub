        ...
        <div id="home_page" className="page-content">
          <div className="left-part container">
            <div className="menu-bar">
              <div className="tab selected" name="category">
                키
              </div>
              <div className="tab" name="setting">
                설정
              </div>
            </div>
                        ...
                        <>
                          {this.state.cur_fid !== null && (
                            <div className="navigator">
                              <div className="back-btn" onClick={this.backPathHistory}>
                                <IoChevronBack />
                                상위 폴더로 가기
                              </div>
                            </div>
                          ...
                          <div className="entries">
                            {this.state.folders.map((folder) => (
                              <div
                                ...
                                key={folder.fid}
                                onClick={(e) => this.enterFolder(folder)}
                              ...
                              >
                                ...
                                <div
                                  className={
                                    "controller " + (this.state.editing_folder_id === folder.fid ? "focus" : "")
                                  }
                                >
                                  <div className="edit un-unfocusable" onClick={(e) => this.editFolder(e, folder)}>
                                    수정
                                  </div>
                                  <div className="del un-unfocusable" onClick={(e) => this.deleteFolder(e, folder)}>
                                    삭제
                                  </div>
                                </div>
                              </div>
                            ...
                            {this.state.items.map((item) => (
                              <div
                                className="entry-item"
                                key={item.iid}
                                onClick={(e) => this.revealItem(item)}
                              ...
                              >
                                ...
                                <div
                                  className={"controller " + (this.state.editing_item_id === item.iid ? "focus" : "")}
                                >
                                  <div className="edit un-unfocusable" onClick={(e) => this.editItem(e, item)}>
                                    수정
                                  </div>
                                  <div className="del un-unfocusable" onClick={(e) => this.deleteItem(e, item)}>
                                    삭제
                                  </div>
                                </div>
                              </div>
                            ...
                            <div className="create">
                              <div className="add" onClick={this.createFolder}>
                                폴더 추가
                              </div>
                              <div className="add" onClick={this.createItem}>
                                항목 추가
                              </div>
                            </div>
                          </div>
                        ...
                        <div className="entries">
                          {this.state.searched_folders.map((folder) => (
                            ...
                            >
                              ...
                              <div
                                className={"controller " + (this.state.editing_folder_id === folder.fid ? "focus" : "")}
                              >
                                <div className="edit un-unfocusable" onClick={(e) => this.editFolder(e, folder)}>
                                  수정
                                </div>
          ...
          <div className="right-part container">
            {cur_iid ? (
              ...
              <div className="item-info info-container">
                <div className="item-path">{folder_hierarchy_list.map((e) => e.name).join(" > ")}</div>
                <div className="item-summary">
